            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
              ...
              >
                ...
                <div className="h-64 flex items-center justify-center">
                  <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Chart data will be displayed here</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="h-64 flex items-center justify-center">
                  <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Chart will be displayed here</p>
                </div>
              </motion.div>
            </div>
